...
import 'package:report_app/location/location_search_dialogue.dart';
    ...
    return GetBuilder<LocationController>(builder: (locationController) {
      return Scaffold(
        ...
        body: Stack(children: <Widget>[
          GoogleMap(
            //as map is created, its stored in this global variable aka controller
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () => Get.dialog(
                  LocationSearchDialogue(mapController: _mapController)),
              child: Container(
                height: 50,
                ...
                child: Row(children: [
                  ...
                  SizedBox(width: 5),
                  //method to show typed in location, magic happens here
                  Expanded(
                    child: Text(
